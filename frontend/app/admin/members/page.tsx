  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <ErrorBanner testId="admin-members-error" message={error} />
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {members.map((member) => (
                  <tr key={member.id} data-testid={`member-row-${member.id}`} className="border-b border-[var(--border)] hover:bg-[var(--hover)]">
                    ...
                    <td className="py-3 px-4">
                      <span data-testid={`member-status-${member.id}`} className={`text-xs px-2 py-0.5 rounded-full ${
