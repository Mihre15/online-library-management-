            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filteredLoans.map((loan) => (
                  <tr key={loan.loanId} className="border-b border-[var(--border)] hover:bg-[var(--hover)]">
                    ...
                    <td className="py-3 px-4">
                      <span className={`text-xs px-2 py-0.5 rounded-full ${statusBadgeClass(loan.status)}`}>
                        {loan.status}
                      </span>
                    </td>
