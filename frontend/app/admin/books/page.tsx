  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <ErrorBanner testId="admin-books-error" message={error} />
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {books.map(book => (
                  <tr key={book.id} data-testid={`admin-book-row-${book.id}`} className="border-b border-[var(--border)] hover:bg-[var(--hover)]">
